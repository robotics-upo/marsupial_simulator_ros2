...
class DroneController(Node):
    ...
    def __init__(self):
        ...
        self.target_position = None   # None: guard funcional hasta recibir primer target
    ...
    def control_loop(self):
        ...
        if distance_to_target >= self.tolerance:
            ...
            # TODO(precision): velocidad en marco mundial; convertir a marco cuerpo
            # usando el yaw del dron para mayor precisión en giros.
            cmd_vel.linear.x = (direction_x / distance_to_target) * desired_speed
            cmd_vel.linear.y = (direction_y / distance_to_target) * desired_speed
            cmd_vel.linear.z = (direction_z / distance_to_target) * desired_speed
