...
def generate_launch_description():
    uav_x = LaunchConfiguration('uav_x', default='3.0')
    uav_y = LaunchConfiguration('uav_y', default='0.0')
    uav_z = LaunchConfiguration('uav_z', default='3.8')
    ugv_x = LaunchConfiguration('ugv_x', default='3.0')
    ...
    return LaunchDescription([
        DeclareLaunchArgument('uav_x', default_value='3.0', description='Initial X position for UAV'),
        DeclareLaunchArgument('uav_y', default_value='0.0', description='Initial Y position for UAV'),
        DeclareLaunchArgument('uav_z', default_value='3.8', description='Initial Z position for UAV'),
        DeclareLaunchArgument('ugv_x', default_value='3.0', description='Initial X position for UGV'),
